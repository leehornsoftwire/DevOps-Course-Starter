...
trello_key = input("Enter trello key: ")
trello_token = input("Enter trello token: ")
trello_board = input("Enter trello board id: ")
rendered = template.render(secret_key=secret_key, trello_key=trello_key, trello_token=trello_token, trello_board=trello_board)
